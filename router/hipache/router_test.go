...
func (s *S) TestAddBackend(c *gocheck.C) {
	conn = &ttesting.ResultCommandRedisConn{
	...
	c.Assert(err, gocheck.IsNil)
	expected := []ttesting.RedisCommand{
...
func (s *S) TestRemoveBackend(c *gocheck.C) {
	...
	conn = &ttesting.ResultCommandRedisConn{Reply: reply, FakeRedisConn: s.fake}
	router := hipacheRouter{}
...
func (s *S) TestAddRoute(c *gocheck.C) {
	conn = &ttesting.ResultCommandRedisConn{DefaultReply: "", FakeRedisConn: s.fake}
	router := hipacheRouter{}
...
func (s *S) TestAddTwoRoutes(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		{Cmd: "RPUSH", Args: []interface{}{"frontend:tip.golang.org", "http://10.10.10.10:8081"},
			Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:tip"}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, expected)
}
...
func (s *S) TestAddRouteCommandFailure(c *gocheck.C) {
	conn = &ttesting.FailingFakeRedisConn{}
	err := hipacheRouter{}.AddRoute("tip", "http://www.tsuru.io")
	c.Assert(err, gocheck.NotNil)
	e, ok := err.(*routeError)
	c.Assert(ok, gocheck.Equals, true)
...
func (s *S) TestAddRouteAlsoUpdatesCNameRecordsWhenExists(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		...
		{Cmd: "LRANGE", Args: []interface{}{"frontend:tip.golang.org", 0, -1},
			Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:tip"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"cname:tip"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"frontend:mycname.com"}, Type: ttesting.CmdDo},
		{Cmd: "SET", Args: []interface{}{"cname:tip", "mycname.com"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:mycname.com", "http://10.10.10.10:8080"},
			Type: ttesting.CmdDo},
...
func (s *S) TestGetCName(c *gocheck.C) {
	conn = &ttesting.ResultCommandRedisConn{DefaultReply: "coolcname.com", FakeRedisConn: s.fake}
	cname, err := hipacheRouter{}.getCName("myapp")
	c.Assert(err, gocheck.IsNil)
	c.Assert(cname, gocheck.Equals, "coolcname.com")
	expected := []ttesting.RedisCommand{
		{Cmd: "GET", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, expected)
}
...
func (s *S) TestSetCName(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		...
		{Cmd: "LRANGE", Args: []interface{}{"frontend:myapp.golang.org", 0, -1},
			Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "SET", Args: []interface{}{"cname:myapp", "myapp.com"}, Type: ttesting.CmdDo},
...
func (s *S) TestSetCNameWithPreviousRoutes(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		...
		{Cmd: "LRANGE", Args: []interface{}{"frontend:myapp.golang.org", 0, -1},
			Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "SET", Args: []interface{}{"cname:myapp", "mycname.com"}, Type: ttesting.CmdDo},
...
func (s *S) TestSetCNameRemovesPreviousDefinedCNamesAndKeepItsRoutes(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		{Cmd: "RPUSH", Args: []interface{}{"frontend:myapp.golang.org", "myapp"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:myapp.golang.org", "10.10.10.10"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:mycname.com", "10.10.10.10"}, Type: ttesting.CmdDo},
		{Cmd: "LRANGE", Args: []interface{}{"frontend:myapp.golang.org", 0, -1}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"frontend:mycname.com"}, Type: ttesting.CmdDo},
		{Cmd: "SET", Args: []interface{}{"cname:myapp", "mycname.com"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:mycname.com", "10.10.10.10"}, Type: ttesting.CmdDo},
		{Cmd: "LRANGE", Args: []interface{}{"frontend:myapp.golang.org", 0, -1}, Type: ttesting.CmdDo},
		...
		{Cmd: "DEL", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"frontend:mycname.com"}, Type: ttesting.CmdDo},
		{Cmd: "SET", Args: []interface{}{"cname:myapp", "myothercname.com"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:myothercname.com", "10.10.10.10"}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, expected)
}
...
func (s *S) TestUnsetCName(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		{Cmd: "DEL", Args: []interface{}{"cname:myapp"}, Type: ttesting.CmdDo},
		{Cmd: "DEL", Args: []interface{}{"frontend:myapp.com"}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, expected)
}
...
func (s *S) TestAddr(c *gocheck.C) {
	...
	expected := []ttesting.RedisCommand{
		{Cmd: "LRANGE", Args: []interface{}{"frontend:tip.golang.org", 0, 0}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, expected)
}
...
func (s *S) TestRemoveElement(c *gocheck.C) {
	...
	c.Assert(err, gocheck.IsNil)
	cmds := []ttesting.RedisCommand{
		{Cmd: "LREM", Args: []interface{}{"frontend:myapp.com", 0, "10.10.10.10"}, Type: ttesting.CmdDo},
	}
...
func (s *S) TestSwap(c *gocheck.C) {
	...
	c.Assert(err, gocheck.IsNil)
	cmds := []ttesting.RedisCommand{
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b1.golang.org", "b1"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b1.golang.org", "http://127.0.0.1"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b1"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b2.golang.org", "b2"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b2.golang.org", "http://10.10.10.10"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b2"}, Type: ttesting.CmdDo},
		{Cmd: "LRANGE", Args: []interface{}{"frontend:b1.golang.org", 0, -1}, Type: ttesting.CmdDo},
		{Cmd: "LRANGE", Args: []interface{}{"frontend:b2.golang.org", 0, -1}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b2.golang.org", "http://127.0.0.1"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b2"}, Type: ttesting.CmdDo},
		{Cmd: "LREM", Args: []interface{}{"frontend:b1.golang.org", 0, "http://127.0.0.1"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b1"}, Type: ttesting.CmdDo},
		{Cmd: "RPUSH", Args: []interface{}{"frontend:b1.golang.org", "http://127.0.0.1"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b1"}, Type: ttesting.CmdDo},
		{Cmd: "LREM", Args: []interface{}{"frontend:b2.golang.org", 0, "http://127.0.0.1"}, Type: ttesting.CmdDo},
		{Cmd: "GET", Args: []interface{}{"cname:b2"}, Type: ttesting.CmdDo},
	}
	c.Assert(s.fake.Cmds, gocheck.DeepEquals, cmds)
}
