...
replace (
	github.com/Azure/azure-sdk-for-go => github.com/Azure/azure-sdk-for-go v19.1.1+incompatible
	...
	github.com/rancher/types => github.com/rancher/types v0.0.0-20190827214052-704648244586
