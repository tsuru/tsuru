...
require (
	...
	github.com/tsuru/deploy-agent v0.0.0-00010101000000-000000000000
...
replace github.com/tsuru/deploy-agent => ../deploy-agent/

// replace k8s.io/ingress-gce => /home/nettoclaudio/ingress-gce
