...
webserver:
  port: \":8000\"\" > /etc/gandalf.conf"
    ...
    sudo curl https://raw.github.com/globocom/tsuru/master/misc/git-hooks/post-receive -o /home/git/bare-template/hooks/post-receive
    sudo curl https://raw.github.com/globocom/tsuru/master/misc/git-hooks/pre-receive -o /home/git/bare-template/hooks/pre-receive
    sudo curl https://raw.github.com/globocom/tsuru/master/misc/git-hooks/pre-receive.py -o /home/git/bare-template/hooks/pre-receive.py
...
function start_gandalf() {
    ...
    sudo su -u git gandalf-webserver &
