...
* It's now possible to remove all units from an application. `#1111
  <https://github.com/tsuru/tsuru/issues/1111>`_. Thanks `@lucasweiblen <https://github.com/lucasweiblen>`_
...
* Unit names now are prefixed with application's name. `#1160
  <https://github.com/tsuru/tsuru/issues/1160>`_. Thanks `@lucasweiblen
  <https://github.com/lucasweiblen>`_.
...
* Better error messages on server startup when MongoDB isn't available. `#1125
  <https://github.com/tsuru/tsuru/issues/1125>`_. Thanks `@lucasweiblen
  <https://github.com/lucasweiblen>`_.
...
* Now `tsuru app-remove` not guess app name. `#1106
  <https://github.com/tsuru/tsuru/issues/1106>`_. Thanks `@lucasweiblen
  <https://github.com/lucasweiblen>`_.
