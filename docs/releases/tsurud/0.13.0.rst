...
* tsuru introduces a new authorization system, so after update your
  servers, users will lost access to everything. You can use `this script
  to migrate <https://gist.github.com/tarsisazevedo/d55e40bbcb7f09f1a4b1>`_.
  It will create three generic roles: admin, team-member and team-creator.
  Admin role will be assign to every users in the old admin team, and all users
  will receive team-member and team-creator.
