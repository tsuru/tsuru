...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#List_available_services_and_instances>`_
command:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Create_a_new_service_instance>`_
command:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Bind_an_application_to_a_service_instance>`_
command:
