...
<http://godoc.org/github.com/globocom/tsuru/cmd/tsuru#hdr-Remove_a_service_instance>`_
command:
...
<http://godoc.org/github.com/globocom/tsuru/cmd/tsuru#hdr-Unbind_an_application_from_a_service_instance>`_
command:
