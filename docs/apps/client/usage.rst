...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Create_a_user>`_ and
`login
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Authenticate_within_remote_tsuru_server>`_:
...
`create-team
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Create_a_new_team_for_the_user>`_:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Create_an_app>`_:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#List_apps_that_you_have_access_to>`_:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Display_information_about_an_app>`_
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Add_SSH_public_key_to_tsuru_s_git_server>`_:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Run_an_arbitrary_command_in_the_app_machine>`_:
...
<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru#Restart_the_app_s_application_server>`_.
...
`<http://godoc.go/github.com/globocom/tsuru/cmd/tsuru>`_.
