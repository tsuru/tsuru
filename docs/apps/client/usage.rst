...
<http://godoc.org/github.com/globocom/tsuru/cmd/tsuru#hdr-Create_a_user>`_ and
`login
...
`create-team
<http://godoc.org/github.com/globocom/tsuru/cmd/tsuru#hdr-Create_a_new_team_for_the_user>`_:
