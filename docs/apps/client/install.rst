...
::
    ...
    $ curl -sL https://s3.amazonaws.com/tsuru/dist-cmd/tsuru-linux-amd64.tar.gz | sudo tar -xz -C /usr/bin/
...
::
    ...
    $ curl -sL https://s3.amazonaws.com/tsuru/dist-cmd/tsuru-darwin-amd64.tar.gz | sudo tar -xz -C /usr/bin/
