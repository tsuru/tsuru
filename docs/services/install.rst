...
::
    ...
    $ curl -L https://s3.amazonaws.com/tsuru/dist-cmd/crane-linux-amd64.tar.gz | sudo tar -xz -C /usr/bin/
...
::
    ...
    $ curl -L https://s3.amazonaws.com/tsuru/dist-cmd/crane-darwin-amd64.tar.gz | sudo tar -xz -C /usr/bin/
