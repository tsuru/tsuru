...
Now you can add this service for your applications using the `bind <http://godoc.org/github.com/tsuru/tsuru-clients/tsuru#hdr-Bind_an_application_to_a_service_instance>`_ command
