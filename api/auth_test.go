...
func (s *AuthSuite) TestCreateUser(c *check.C) {
	...
	c.Assert(user.Quota, check.DeepEquals, authTypes.UnlimitedQuota)
}
...
func (s *AuthSuite) TestListUsersFilterByRoleAndContext(c *check.C) {
	...
	otherUser := &auth.User{Email: "groundcontrol@majortom.com", Password: "123456", Quota: authTypes.UnlimitedQuota}
