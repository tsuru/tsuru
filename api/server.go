...
func RunServer(dry bool) http.Handler {
	...
	m.Add("Get", "/apps/{app}/restart", authorizationRequiredHandler(restart))
	m.Add("Get", "/apps/{app}/start", authorizationRequiredHandler(start))
	m.Add("Get", "/apps/{app}/stop", authorizationRequiredHandler(stop))
