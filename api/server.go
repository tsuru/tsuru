...
func RunServer(dry bool) http.Handler {
	...
	m.Add("1.0", "Put", "/apps/{app}", AuthorizationRequiredHandler(updateApp))
	...
	m.Add("1.0", "Post", "/apps/{app}/run", AuthorizationRequiredHandler(runCommand))
	...
	m.Add("1.0", "Get", "/apps/{app}/quota", AuthorizationRequiredHandler(getAppQuota))
	m.Add("1.0", "Put", "/apps/{app}/quota", AuthorizationRequiredHandler(changeAppQuota))
	...
	m.Add("1.0", "Post", "/apps/{app}/units/register", AuthorizationRequiredHandler(registerUnit))
	m.Add("1.0", "Post", "/apps/{app}/units/{unit}", AuthorizationRequiredHandler(setUnitStatus))
	...
	m.Add("1.0", "Post", "/apps/{app}/log", AuthorizationRequiredHandler(addLog))
	m.Add("1.0", "Post", "/apps/{app}/deploy/rollback", AuthorizationRequiredHandler(deployRollback))
	m.Add("1.4", "Put", "/apps/{app}/deploy/rollback/update", AuthorizationRequiredHandler(deployRollbackUpdate))
	m.Add("1.3", "Post", "/apps/{app}/deploy/rebuild", AuthorizationRequiredHandler(deployRebuild))
	...
	m.Add("1.8", "Post", "/apps/{app}/routable", AuthorizationRequiredHandler(appSetRoutable))
	...
	m.Add("1.6", "Get", "/platforms/{name}", AuthorizationRequiredHandler(platformInfo))
	m.Add("1.6", "Post", "/platforms/{name}/rollback", AuthorizationRequiredHandler(platformRollback))
	...
	m.Add("1.0", "Post", "/apps/{appname}/diff", AuthorizationRequiredHandler(diffDeploy))
	...
	m.Add("1.8", "Get", "/pools/{name}", AuthorizationRequiredHandler(getPoolHandler))
