...
func RunServer(flags map[string]interface{}) {
	...
	m.Put("/services/:service/:team", authorizationRequiredHandler(serviceGrantAccess))
	m.Del("/services/:service/:team", authorizationRequiredHandler(serviceRevokeAccess))
