...
func RunServer(dry bool) http.Handler {
	...
	m.Add("1.16", http.MethodGet, "/teams/{name}/users", AuthorizationRequiredHandler(teamUserList))
	m.Add("1.16", http.MethodGet, "/teams/{name}/groups", AuthorizationRequiredHandler(teamGroupList))
