...
func (s *S) TestRoutersList(c *check.C) {
	...
	router.Register("foo", func(_ string, _ routerTypes.ConfigGetter) (router.Router, error) { return nil, nil })
	router.Register("bar", func(_ string, _ routerTypes.ConfigGetter) (router.Router, error) { return nil, nil })
