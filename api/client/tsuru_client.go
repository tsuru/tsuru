...
// NewHTTPClient creates a new tsuru HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Tsuru {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new tsuru HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Tsuru {
...
// New creates a new tsuru client
