...
var (
	...
	PermAppUpdateConfig                  = PermissionRegistry.get("app.update.config")                   // [global app team pool]
	PermAppUpdateConfigSet               = PermissionRegistry.get("app.update.config.set")               // [global app team pool]
	PermAppUpdateConfigUnset             = PermissionRegistry.get("app.update.config.unset")             // [global app team pool]
