...
var (
	...
	PermPoolUpdateConstraint             = PermissionRegistry.get("pool.update.constraint")              // [global pool]
	PermPoolUpdateConstraintSet          = PermissionRegistry.get("pool.update.constraint.set")          // [global pool]
