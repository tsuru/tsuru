...
func (s *S) TestMigrateAppTsuruServicesVarToServiceEnvs(c *check.C) {
	tests := []struct {
		app                 app.App
		expected            []bindTypes.ServiceEnvVar
		...
		},
		{
			...
			expected: []bindTypes.ServiceEnvVar{
				...
				{
					EnvVar:       bindTypes.EnvVar{Name: "ENV1", Value: "val2"},
					ServiceName:  "srv1",
					InstanceName: "myinst2",
				},
				{
					EnvVar:       bindTypes.EnvVar{Name: "ENV1", Value: "val3"},
					ServiceName:  "srv1",
		...
		},
		{
			app: app.App{
				...
				ServiceEnvs: []bindTypes.ServiceEnvVar{
					{
						EnvVar:       bindTypes.EnvVar{Name: "NO_MIGRATION_VAR", Value: "valx"},
						ServiceName:  "srv2",
						InstanceName: "myinst",
					},
				},
		...
		},
		{
			...
			expected: []bindTypes.ServiceEnvVar{
				...
				{
					EnvVar:       bindTypes.EnvVar{Name: "ENV3", Value: "val3"},
					ServiceName:  "srv3",
					InstanceName: "myinst2",
				},
			},
